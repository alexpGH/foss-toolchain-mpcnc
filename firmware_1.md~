...
## A) Grbl on Ramps (and possibly others<sup>*1</sup>) – for the default mpcnc setup (no dual end stops)
### Controller & firmware
...
For boards running gbrl [bCnC](bcnc_1.html) is a great solution, as it runs on python and therefore should be available on many platforms.
