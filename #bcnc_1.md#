...
### Preamble
We are focusing here on the gantry setup having dual motors per axis x (x & xc) and y (y & yc) - [don't remember? check again here](zoom_1#veryBasics).<br>
...
your pins &#8594;[recheck your understanding & config](zoom_1#endstopBackground) 
